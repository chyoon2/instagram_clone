...
- make header component responsive to browser window > 400px so search bar dissapears.
  -refactor controller and the multople post footer componenets.
...
- User can scroll down a **MainFeed** and view other users posts.
- Comment on post
- Like post.

#### Suggestions Component

- User can view a list of suggested users to follow.
- This component is hidden depending on size of browser, media-query.
  <br>
